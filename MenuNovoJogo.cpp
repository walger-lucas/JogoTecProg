...
{
    botaoApertado.loadFromFile("Arquivos/Imagens/cubo.png");
    botaoDesapertado.loadFromFile("Arquivos/Imagens/button0.png");
}
MenuNovoJogo::~MenuNovoJogo()
{
    if(doisJog)
...
{
    umJog = new BotaoEntidade(Vector2f(1.5,-1.4),0.3,"Um Jogador",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::UmJogador,this),nullptr);
    doisJog = new BotaoEntidade(Vector2f(4.8,-1.4),0.3,"Dois Jogadores",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::DoisJogadores,this),nullptr);
    cena1 = new BotaoEntidade(Vector2f(1.5,-2.8),0.3,"Primeira Fase",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::Cena1,this),nullptr);
    cena2 = new BotaoEntidade(Vector2f(4.8,-2.8),0.3,"Segunda Fase",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::Cena2,this),nullptr);
    comecar = new BotaoEntidade(Vector2f(3.0,-4),0.3,"Iniciar Jogo",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::Comecar,this),nullptr);
    voltar= new BotaoEntidade(Vector2f(0.2,-0.2),0.3,"Voltar",Vector2f(-50,-30),"button0.png","ARIAL.TTF",std::bind(&MenuNovoJogo::Voltar,this),nullptr);
